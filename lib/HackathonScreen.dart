...
class _ShowMaterialScreenState extends State<HackathonScreen> {
  String searchQuery = '';
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => HackathonDetailsScreen(
                                  hackathon: material.data() as Map<String, dynamic>, // Pass project data
                                ),
                              ),
                            );
                          },
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height: 8),
                                  Text(material['problemStatement'],style: TextStyle(color: Colors.grey[600],),),
                                  SizedBox(height: 8),
                                  Text(
